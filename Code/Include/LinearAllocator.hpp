...
namespace Kayou::Memory
{
    ...
    private:
        ...
        /// @brief Internal helper function used to align memory internally
        ...
        KAYOU_ALWAYS_INLINE static std::size_t AlignForward(const std::size_t ptrAddress, const std::size_t memAlignment)
        {
